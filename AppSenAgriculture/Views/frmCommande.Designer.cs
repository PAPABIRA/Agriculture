...
namespace AppSenAgriculture.Views
{
    partial class frmCommande
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblTitre.Size = new Size(350, 28);
            ...
            this.lblStatut.Font = new Font("Segoe UI", 8.5f, FontStyle.Bold);
            this.lblStatut.ForeColor = AppTheme.DarkGray;
            this.lblStatut.Location = new Point(15, y);
            this.lblStatut.Size = new Size(w, 16);
            y += 18;

            this.cboStatut.DropDownStyle = ComboBoxStyle.DropDownList;
            this.cboStatut.Items.AddRange(new object[] { "En attente", "Confirmée", "Livrée", "Annulée" });
            this.cboStatut.Location = new Point(15, y);
            this.cboStatut.Size = new Size(w, 26);
            y += 40;
            ...
            this.pnlForm.Controls.AddRange(new Control[] {
                this.lblDate, this.dtpDate, this.lblStatut, this.cboStatut,
            ...
            this.lblTotal.Text = "Total : 0 commande(s)";
        ...
        private Label lblTitre, lblDate, lblStatut, lblTotal;
